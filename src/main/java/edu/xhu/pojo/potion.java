...
public class potion {
    ...
    public potion(Integer appartus_id, String appartus_no, String appartus_name, float appartus_price, Integer appartus_quantity, String appartus_ren) {
    ...
    public potion(String appartus_no, String appartus_name, float appartus_price, Integer appartus_quantity, String appartus_ren) {
        this.appartus_no = appartus_no;
        this.appartus_name = appartus_name;
        this.appartus_price = appartus_price;
        this.appartus_quantity = appartus_quantity;
